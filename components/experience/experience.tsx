import { bebasNeue, manrope400, manrope500 } from '@/utils/fonts'
    ...
    return (
        <section id="aboutme" className="flex flex-col ml-6 mb-14 md:ml-36 2xl:ml-72 md:flex-row mt-20 gap-20 md:gap-52 md:mb-36">
            <div className="flex flex-col md:mx-0 gap-2">
                <h2 className={`${bebasNeue.className} md:text-7xl text-5xl`}> {language ? "MY EXPERIENCE" : "MI EXPERIENCIA"}</h2>
                <p className={`${manrope400.className} max-w-80`}>{language ? "Here you will see my experience only as a developer, the rest is on my linkedin" : "Aquí veras mi experiencia unicamente como desarrollador, el resto se encuentra en mi linkedin"}</p>
            </div>
